...
//        List<Integer> filteredDirectories = allDirectories.stream()
//                .map(Directory::calculateDirectorySize)
//                .filter(ds -> ds < 100000)
//                .collect(Collectors.toList());

        allDirectories.forEach(
                dir -> System.out.println(dir.calculateDirectorySize(dir.getDirectories()))
        );
    }
